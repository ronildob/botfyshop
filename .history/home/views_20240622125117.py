    ...
    if request.method == "GET":
        ...
        if request.user.is_authenticated:
            ...
            try: 
                ...
                if pais == "Brasil" or pais ==:
                    hora1 = "Segunda a  das 9:00 as 18:00"
                    hora2 = "Segunda a Sexta das 9:00 as 22:00"
                    hora3 = "Segunda a Sábado das 9:00 as 18:00"
                    hora4 = "Segunda a Sábado das 9:00 as 22:00"
                    hora5 = "Segunda a Sexta 9:00 as 18:00, Sábado das 9:00 as 12:00"
                    hora6 = "Segunda a Sexta 9:00 as 22:00, Sábado das 9:00 as 12:00"
                    hora7 = "Todos os dias das 9:00 as 18:00"
                    hora8 = "Todos os dias das 9:00 as 22:00"
                    ...
                    hora2 = "Monday to Friday from 9:00 AM to 10:00 PM"
                    hora3 = "Monday to Saturday from 9:00 AM to 6:00 PM"
                    hora4 = "Monday to Saturday from 9:00 AM to 10:00 PM"
                    hora5 = "Monday to Friday from 9:00 AM to 6:00 PM - Saturday from 9:00 AM to 12:00 PM"
                    hora6 = "Monday to Friday from 9:00 AM to 10:00 PM - Saturday from 9:00 AM to 12:00 PM"
                    hora7 = "Every day from 9:00 AM to 6:00 PM"
