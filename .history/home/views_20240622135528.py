        ...
        if request.user.is_authenticated:
            ...
            if formulario_user:
                ...
                if pais == "Brasil":
                    ...
                    paginas = {
                            "Track Order": "static/home/politicas/Track Orders.txt",
        ...
        if request.user.is_authenticated:
            ...
            try: 
                ...
                if pais == "Brasil" or pais == "Portugal":
                    ...
                    footer = f"""<p><strong>Email:\u00a0</strong><a href="mailto:{email_suporte}">{email_suporte}</a></p><p><strong>WhatsApp:</strong>\u00a0<a href="https://wa.me/{whatsapp_completo}">{cod_pais[pais]} {whatsapp}</a></p><p><strong>Business Hours: </strong>{antend}</p>"""
                    ...
                    if business_hours == "hora1":
                        ...
                        antend = "Lunes a viernes de 9:00 a 22:00 - Sábado de 9:00 a 12:00"
                    elif business_hours == "hora7":
                        antend = "Todos los días de 9:00 a 18:00"
                    elif business_hours == "hora8":
                        antend = "Todos los días de 9:00 a 22:00"
                    footer = f"""<p><strong>Correo electrónico:\u00a0</strong><a href="mailto:{email_suporte}">{email_suporte}</a></p><p><strong>WhatsApp:</strong>\u00a0<a href="https://wa.me/{whatsapp_completo}">{cod_pais[pais]} {whatsapp}</a></p><p><strong>Horario de atención: </strong>{antend}</p>"""
