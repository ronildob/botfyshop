    ...
    if request.method == "GET":
        ...
        if request.user.is_authenticated:
            ...
            try: 
                ...
                if pais == "Brasil":
                    if <div class="form__input-row">
                                <div class="form__input-wrapper form__input-wrapper--labelled">
                                    <select id="business_hours" name="business_hours" class="form__field form__field--select form__field--large" required>
                                    <option value="">Select the Support Hours</option>
                                    <option value="Monday to Friday from 9:00 AM to 6:00 PM">Monday to Friday from 9:00 AM to 6:00 PM</option>
                                    <option value="Monday to Friday from 9:00 AM to 10:00 PM">Monday to Friday from 9:00 AM to 10:00 PM</option>
                                    <option value="Monday to Saturday from 9:00 AM to 6:00 PM">Monday to Saturday from 9:00 AM to 6:00 PM</option>
                                    <option value="Monday to Saturday from 9:00 AM to 10:00 PM">Monday to Saturday from 9:00 AM to 10:00 PM</option>
                                    <option value="Monday to Friday from 9:00 AM to 6:00 PM - Saturday from 9:00 AM to 12:00 PM">Monday to Friday from 9:00 AM to 6:00 PM - Saturday from 9:00 AM to 12:00 PM</option>
                                    <option value="Monday to Friday from 9:00 AM to 10:00 PM - Saturday from 9:00 AM to 12:00 PM">Monday to Friday from 9:00 AM to 10:00 PM - Saturday from 9:00 AM to 12:00 PM</option>
                                    <option value="Every day from 9:00 AM to 6:00 PM">Every day from 9:00 AM to 6:00 PM</option>
                                    <option value="Every day from 9:00 AM to 10:00 PM">Every day from 9:00 AM to 10:00 PM</option>                        
                                    </select>
                                </div>
                            </div>

                    footer = f"""<p><strong>E-mail:\u00a0</strong><a href="mailto:{email_suporte}">{email_suporte}</a></p><p><strong>WhatsApp:</strong>\u00a0<a href="https://wa.me/{whatsapp_completo}">{cod_pais[pais]} {whatsapp}</a></p><p><strong>Hor\u00e1rio de atendimento: </strong>{business_hours}</p>"""
                    titlezap = f"Fale Conosco \n<span>\nO melhor suporte é com a {empresa}!\n</span>"
                elif pais == "Portugal":
                    footer = f"""<p><strong>E-mail:\u00a0</strong><a href="mailto:{email_suporte}">{email_suporte}</a></p><p><strong>WhatsApp:</strong>\u00a0<a href="https://wa.me/{whatsapp_completo}">{cod_pais[pais]} {whatsapp}</a></p><p><strong>Hor\u00e1rio de atendimento: </strong>{business_hours}</p>"""
                    titlezap = f"Fale Connosco \n<span>\nO melhor suporte é com a {empresa}!\n</span>"
                elif pais == "Pakistan":
